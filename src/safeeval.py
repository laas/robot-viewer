...
all_builtins = globals()['__builtins__'].keys()
# print "all_builtins = ",all_builtins
#----------------------------------------------------------------------
# Utilties.
#----------------------------------------------------------------------
...
for ast_name in unallowed_ast_nodes:
    if not is_valid_ast_node(ast_name):
        raise Exception("%s is not in ast_name: %s"%(ast_name, all_ast_nodes))
for name in unallowed_builtins:
    if not is_valid_builtin(name):
        raise Exception("%s is not in builtins: %s"%(name, all_builtins))
